...
#alias zoey-startxkde='export XSESSION=kde-4;startx'
...
#PROMPT=$(echo '%{\033[34m%}%M%{\033[1;35m%}%/
#%{\033[1;36m%}%n %{\033[01;31m%}>%{\033[33m%}>%{\033[34m%}>%{\033[m%} ')
RPROMPT=$(echo '%{\033[31m%}%D %T%{\033[m%}')
PROMPT=$(echo '%{\033[1;36m%}%y : %{\033[1;35m%}%~
%{\033[33m%}>%{\033[m%} ')
#}}}
 ...
 recolor-cmd() {
     ...
     for arg in ${(z)BUFFER}; do
         ...
         if $colorize; then
             ...
             case $res in
                 *'reserved word'*)   style="fg=blue,bold";;
                 *'alias for'*)       style="fg=magenta,bold";;
                 *'shell builtin'*)   style="fg=yellow,bold";;
                 *'shell function'*)  style='fg=cyan,bold';;
                 *"$arg is"*)
                     [[ $arg = 'sudo' ]] && style="fg=red,bold" || style="fg=green,bold";;
                 *)                   style='none,bold';;
             esac
